package Data::Hopen::Arrrgs;     # A tweaked version of Getopt::Mixed
...
Data::Hopen::Arrrgs - Perl extension allowing subs to handle mixed parameter lists
...
Always exports C<parameters> by default. If you do not want this, use:
  ...
  use Data::Hopen::Arrrgs ();
  # OR
  require Data::Hopen::Arrrgs;

  # ...
  my %args = Data::Hopen::Arrrgs::parameters([ qw( x y z ) ], @_);
